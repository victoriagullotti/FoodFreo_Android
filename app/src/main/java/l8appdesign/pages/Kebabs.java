...
public class Kebabs extends Activity implements ViewSwitcher.ViewFactory {
    ...
    Integer imageIDs[] =
            {
                    R.drawable.lambkebabs,
                    R.drawable.chickenkebabs,
                    R.drawable.mixedkebab
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kebabs);
        ...
        name="Lamb Kebab";
        label = "Lamb Kebab";
        bio = "“Lamb, fresh lettuce, tomato and onions. Choose two free sauces: BBQ, Tomato, Garlic, Sweetchilli, Sour Cream, Mayo, Satay, Chilli..” \n" +
                "\n" ;
        email = "$13";
        instagram = "";
        ...
        gallery.setAdapter(new Kebabs.ImageAdapter(this));
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch(variable){  // assign the variable below
                    ...
                    case 1:
                        name = "Chicken Kebab";
                        label = "Chicken Kebab";
                        bio = "“Chicken, fresh lettuce, tomato and onions. Choose two free sauces: BBQ, Tomato, Garlic, Sweetchilli, Sour Cream, Mayo, Satay, Chilli..” \n" +
                                "\n" ;
                        instagram = "";
                        email = "14.00";
                        studentName.setText(name); studentBio.setText(bio); studentInstagram.setText(instagram); studentEmail.setText(email); studentLabel.setText(label);
                    ...
                    case 2:
                        name = "Mixed Kebab";
                        label = "Mixed Kebab";
                        bio = "“Chicken, lamb, fresh lettuce, tomato and onions. Choose two free sauces: BBQ, Tomato, Garlic, Sweetchilli, Sour Cream, Mayo, Satay, Chilli..” \n" +
                                "\n" ;
                        instagram = "";
                        email = "14.00";
                        studentName.setText(name); studentBio.setText(bio); studentInstagram.setText(instagram); studentEmail.setText(email); studentLabel.setText(label);
