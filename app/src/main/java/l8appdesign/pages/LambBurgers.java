...
public class LambBurgers extends Activity implements ViewSwitcher.ViewFactory {
    ...
    Integer imageIDs[] =
            {
                    R.drawable.lambburger,
                    R.drawable.lambcheese,
                    R.drawable.lambhawaiian,
                    R.drawable.maroccan,
                    R.drawable.lambmeatlovers,
                    R.drawable.lambmeatlovers,
                    R.drawable.lambburger
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lambburgers);
        ...
        name="Classic Lamb";
        label = "Classic Lamb";
        bio = "“Char grilled ground prime lamb, fresh tomato, kettuce, onions, tomato sauce and japanese mayo” \n" +
                "\n" ;
        email = "$13";
        instagram = "";
        ...
        gallery.setAdapter(new LambBurgers.ImageAdapter(this));
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch(variable){  // assign the variable below
                    ...
                    case 1:
                        name = "Lamb Cheese";
                        label = "Lamb Cheese";
                        bio = "“Char grilled ground prime lamb, tasty cheese, fresh tomato, lettuce, onion, tomato sauce and Japanese mayo” \n" +
                                "\n" ;
                        instagram = "";
                        email = "14.00";
                        studentName.setText(name); studentBio.setText(bio); studentInstagram.setText(instagram); studentEmail.setText(email); studentLabel.setText(label);
                    ...
                    case 3:
                        name = "Maroccan";
                        label = "Camembert";
                        bio = "“Char grilled ground prime lamb, tasty cheese, fresh tomato, lettuce, onions, harrisa and youghurt dressing”” \n" +
                                "\n" ;
                        instagram = "";
                        email = "15.00" +
                                "";
                    ...
                    case 2:
                        name = "Lamb Hawaiian Sunset";
                        label = "Lamb Hawaiian Sunset";
                        bio = "“Char grilled ground prime lamb, tasty cheese, golden pineapple, fresh tomato, lettuce, onions, tomato sauce and Japanese mayo ...” \n" +
                                "\n" ;
                        instagram = "";
                        email = "$14.00";
                        studentName.setText(name); studentBio.setText(bio); studentInstagram.setText(instagram); studentEmail.setText(email); studentLabel.setText(label);
                        break;
                    case 4:
                        name = "Lamb Meat Lovers";
                        label = "Lamb Meat Lovers";
                        ...
                        break;
                    case 5:
                        name = "Romma Lamb Deluxe";
                        label = "Romma Lamb Deluxe";
