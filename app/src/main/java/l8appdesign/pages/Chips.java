...
public class Chips extends Activity implements ViewSwitcher.ViewFactory {
    ...
    Integer imageIDs[] =
            {
                    R.drawable.regularchips,
                    R.drawable.largechips
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gallery.setAdapter(new Chips.ImageAdapter(this));
