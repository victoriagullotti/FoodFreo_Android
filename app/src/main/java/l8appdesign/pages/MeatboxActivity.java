...
public class MeatboxActivity extends Activity implements ViewSwitcher.ViewFactory{
    ...
    Integer imageIDs[] =
            {
                    R.drawable.chcikenmeatbox,
                    R.drawable.lambmeatbox,
                    R.drawable.mixedmeatbox
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.meatbox);
        ...
        label = "Chicken Meatbox";
        bio = "“Chicken box served with chips with chips and shredded tasty cheese. Choose two free sauces: BBQ, Tomato, Garlic, Sweetchilli, Sour Cream, Mayo, Satay, Chilli..” \n" +
                "\n" ;
        email = "$16";
        instagram = "";
        ...
        gallery.setAdapter(new MeatboxActivity.ImageAdapter(this));
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch(variable){  // assign the variable below
                    ...
                    case 1:
                        name = "Lamb Meatbox";
                        label = "Lamb Meatbox";
                        bio = "“Lamb box served with chips with chips and shredded tasty cheese. Choose two free sauces: BBQ, Tomato, Garlic, Sweetchilli, Sour Cream, Mayo, Satay, Chilli..” \n" +
                                "\n" ;
                        instagram = "";
                        email = "16.00";
                        studentName.setText(name); studentBio.setText(bio); studentInstagram.setText(instagram); studentEmail.setText(email); studentLabel.setText(label);
                    ...
                    case 2:
                        name = "Mixed Meatbox";
                        label = "Lamb Meatbox";
                        bio = "“Chicken and Lamb box served with chips with chips and shredded tasty cheese. Choose two free sauces: BBQ, Tomato, Garlic, Sweetchilli, Sour Cream, Mayo, Satay, Chilli..” \n" +
                                "\n" ;
                        instagram = "";
                        email = "18.00";
                        studentName.setText(name); studentBio.setText(bio); studentInstagram.setText(instagram); studentEmail.setText(email); studentLabel.setText(label);
